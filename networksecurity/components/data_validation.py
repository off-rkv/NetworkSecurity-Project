...
class DataValidation:
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            df_numerical_columns = [col for col in train_dataframe.columns if col in numerical_columns]

            if len(df_numerical_columns) != len(numerical_columns):
                raise Exception("Numerical columns count does not match schema")
