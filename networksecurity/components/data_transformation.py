...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        '''Initialises a KNNImputer object with the parameters 
        specified in the training_pipelin.py file and return 
        a Pipeline object with the KNNImputer object as the first 
        step
