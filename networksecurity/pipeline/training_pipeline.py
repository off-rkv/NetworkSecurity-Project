...
class TrainingPipeline:
    ...
    def start_transformation(self,data_validation_artifact:DataValidationArtifact):
        try:
            data_transformation_config=DataTransformationConfig(training_pipeline_config=self.training_pipeline_config)
            #logging.info('Data transformation started')
            data_tranformation=DataTransformation(data_validation_artifact,data_transformation_config=data_transformation_config)
    ...
    def run_pipeline(self):
        try:
            ...
            data_transformation_artifact = self.start_transformation(data_validation_artifact=data_validation_artifact)
